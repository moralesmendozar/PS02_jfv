function rho = residual_fcn(alpha,beta,delta,nu,gamma,k_min,k_max,rho,grid_k,T_k,Z,PI,node_num,shock_num,M)
        ...
        for z_index = 1:shock_num
            ...
            for k_index = 1:node_num % Loop 2 over collocation point on k
                ...
                for zp_index = 1:shock_num
                    ...
                    Ucp = ((cp^nu*(1-lp)^(1-nu))^(1-gamma))/cp;
                ...
                euler_lhs = (c^nu*(1-l)^(1-nu))^(1-gamma)/c;
                bellman_rhs = (1-beta)*((c^nu*(1-l)^(1-nu))^(1-gamma))/(1-gamma)...
