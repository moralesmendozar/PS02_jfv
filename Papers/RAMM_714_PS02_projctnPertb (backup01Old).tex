...
%&&   E_z \left[\frac{1}{1+r_i}                                               \theta_1 \alpha_1 (k_{1,i,t}^T)^{\frac{-1}{\lambda_1}} \left( \theta_1 (k_{1,i,t}^T)^{\frac{\lambda_1-1}{\lambda_1}} +(1-\theta_1)(k_{1,i,t}^I)^{\frac{\lambda_1-1}{\lambda_1}} \right)^{\frac{\lambda_1}{\lambda_1-1}\alpha_1-1} \left( e^{z_{1,i,t}}l_{1,i,t} \right)^{\gamma_1}                                           \right] \\  [k_1^I]: 
